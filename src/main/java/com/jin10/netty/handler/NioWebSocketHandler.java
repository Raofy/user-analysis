package com.jin10.netty.handler;
...
import static com.jin10.utils.AnalysisUtils.putEvent;
...
public class NioWebSocketHandler extends SimpleChannelInboundHandler<Object> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof FullHttpRequest) {
            ...
            List<AnalysisHis> iosList = hisService.list(new LambdaQueryWrapper<AnalysisHis>().eq(AnalysisHis::getPlatform, "ios").orderByDesc(AnalysisHis::getCreateTime));
            List<AnalysisHis> androidList = hisService.list(new LambdaQueryWrapper<AnalysisHis>().eq(AnalysisHis::getPlatform, "android").orderByDesc(AnalysisHis::getCreateTime));

            putEvent(iosList);
            putEvent(androidList);

            JSONObject jsonObject = new JSONObject();
            jsonObject.put("ios", iosList);
            jsonObject.put("android", androidList);
